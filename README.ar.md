...
# 🦁 XXD Panel 083｜دفتر الشخصيات القبيحة الظريفة

### يحوّل شخصية الصورة إلى شخصية قبيحة-لطيفة قليلة وغريبة ودقيقة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 083 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تنتج إعادة رسم الصورة كاملةً رسماً خطياً مملاً، بينما يمحو الرسم الجميل والصحيح أكثر من اللازم شخصية الموضوع وحركته ومفارقته وحرجه.

لا يحتفظ **Panel 083** إلا بعنصر واحد راسخ في الذاكرة وإشارة بيئية أو اثنتين، ثم يشوّه بنسبة مضبوطة تناسباً أو حركةً أو تعبيراً أو بنية. تصنع المحيطات المرتجفة والنسب الخاطئة عمداً والشمع الخشن والفراغ أسلوب Ugly-cute naïve doodle، وتأتي الهوية والفكاهة بدقة من الأصل.

### مناسب لـ

- صور تحمل حركة أو تعبيراً أو نسبة أو مفارقة ذات شخصية تصلح للتحويل إلى فكاهة؛
- قبح لطيف أخرق ومائل عمداً من دون أن يصير لطافة عامة أو يفقد قابلية التعرّف؛
- اختزال مشهد معقد إلى عنصر واحد وإشارات قليلة ولون خشن وفراغ واسع راسخ في الذاكرة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 083 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** خربشة Ugly-cute ساذجة · رسم Wonky · عدم دقة مضبوطة · بطل فكاهي واحد · شمع خشن · قليل وغريب وأخرق ودقيق
...
|---|---|
| **الناتج** | ملصق شخصية مضحك يشبه كتيب خربشات ugly-cute مستقلاً |
| **البصمة الواضحة** | محيط مرتجف غير متساوٍ، نسب خاطئة عمداً، لون خشن قليل، عنصر واحد وفراغ فاتح واسع |
| **احترام المصدر** | تأتي الهوية والفكاهة من الصورة، ولا يُبالغ إلا في الحركة أو المفارقة أو التعبير أو البنية الأكثر شخصيةً |
...
```text
إعادة فهم الصورة قبل الرسم → إبقاء عنصر راسخ وإشارتين ضروريتين كحد أقصى → اختيار أطرف حركة أو مفارقة أو تعبير أو استعارة → المبالغة بخطأ مضبوط ومحيط wonky → تبسيط ألوان الأصل إلى شمع خشن → حفظ الفراغ الفاتح → إضافة تعليق ساخر واحد عند الحاجة
```

## سمات النتيجة النهائية

- يحمل عنصر رئيس واحد السرد، وتحذف الأشياء البيئية ما لم تكن ضرورية حقاً.
- تكون النسب والمنظور والمحيطات خاطئة عمداً، لكن الخطأ مضبوط وقابل للتعرّف.
- تصنع أقلام الشمع واللون والفرشاة الجافة والملء الناقص والتجاوز وحبيبات الورق سطح كتيب شخصي.
- يعزز التكبير والتصغير والإزاحة والقص والتعليق شخصية العنصر الكوميدية.
- يتصرف النص كتعليق ساخر أو ملاحظة أو قول جانبي صغير، لا كنظام معلومات.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-083-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 083. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-083 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-083 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-083 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-083 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-083 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 083 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-083 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-083`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-083-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-083-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ83 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 083 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–083) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
