...
```text
/xxd-panel-083 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，083 设计在下）
2. 左右对照（原图在左，083 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-083/<fresh-task>/
...
- `references/xxd-panel-083-prompt.zh-CN.md`
- `references/xxd-panel-083-prompt.en.md`
